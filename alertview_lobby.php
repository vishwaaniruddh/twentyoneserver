...
Page=strPage;
            ...
            type:'POST',    
   url:'viewalert_process_lobby.php',
...
<form id="formf" name="formf" method="post" action="css_View_alert_export_lobby.php" >
...
function expfunc()
{
$('#formf').attr('action', 'css_View_alert_export_lobby.php').attr('target','_blank');
$('#formf').submit();
