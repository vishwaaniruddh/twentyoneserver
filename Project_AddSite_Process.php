...
{ include 'config.php';?>
    ...
    <html>
       <head>
		 ...
		 <?php $project=$_POST['project'];  if($project=="1" || $project=="4"){ ?>
...
$site_details = "insert into sites_details(site_id, routebrand, router_id, simnumber, simowner, status, created_at,project) values('".$last."', '".$routebrand."', '".$router_id."', '".$simnumber."', '".$simowner."', '1', '".$created_at."','".$project."')" ; 
