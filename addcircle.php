...
<form name="myForm"  action="addcircle_process.php" method="POST" class="form1">
    <div><input type="hidden" name="drop" id="drop"/></div>
    
<div class="row hed"  >
    <div  class="col-md-4"></div>
 <div  class="col-md-4"><center><h2 style="color:white" >Add Circle</h2></center></div>
 <div  class="col-md-4"></div>
</div>
...
<div class="row div1">
    ...
    <div  class="col-md-4"><leble>Name</leble></div>
     <div  class="col-md-4"> <input type="text" name="circle" id="circle" /></div>
      <div  class="col-md-2"></div>
</div>
