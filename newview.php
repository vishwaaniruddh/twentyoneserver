...
Page=strPage;
            ...
            type:'POST',    
   url:'newview_process.php',
   data:'ZH='+ZH+'&from='+from+'&to='+to+'&Page='+Page+'&perpg='+perp,
   ...
   document.getElementById("show").innerHTML=msg;
      ...
      &nbsp;&nbsp;&nbsp;
		...
		<body style="background-color: #dce079">
            ...
            <div>
			<center><h1 style="margin-top:70px; color:#fff;"  ><b> ZH /ZL view</b></h1></center>
...
<td> view :<select id="ZH" name="ZL">                      
  <option value="1">ZH</option>
 <option value="2">ZL</option>
