  ...
  return function(table, name) {
    ...
    window.location.href = uri + base64(format(template, ctx))
        ...
        function TestingAction1(val,id,Atm){
			   ...
			   if(val =="T"){$('#testing'+id).hide();}else{$('#Live'+id).hide();}
...
?>
<option value="<?php echo $Qprojfetch['id'];?>" <?php if($Qprojfetch['id']=="1"){?> selected <?php }?> ><?php echo $Qprojfetch['Name'];?></option>
