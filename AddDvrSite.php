...
<div class="row hed"  >
 ...
 <div  class="col-md-4"><center><h2  >Add DVR site</h2></center></div>
 <div  class="col-md-4"></div>
</div>
...
<div class="row div1">
    ...
    <div  class="col-md-4"><leble>CTS Local Branch</leble></div>
     <div  class="col-md-4"><input type="text" name="CTSLocalBranch" id="CTSLocalBranch" ></div>
     <div  class="col-md-2"></div>
</div>
...
<div class="row div1">
    ...
    <div  class="col-md-4"><leble>CTS BM Name</leble></div>
     <div  class="col-md-4"><input type="text" name="CTS_BM_Name" id="CTS_BM_Name" ></div>
     <div  class="col-md-2"></div>
</div>
...
<div class="row div1">
    ...
    <div  class="col-md-4"><leble>CTS BM Number</leble></div>
     <div  class="col-md-4"><input type="text" name="CTS_BM_Number" id="CTS_BM_Number" ></div>
     <div  class="col-md-2"></div>
</div>
