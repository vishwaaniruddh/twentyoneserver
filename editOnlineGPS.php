...
if (isset($_SESSION['login_user']) && isset($_SESSION['id'])) {
    ...
    $edit = $_REQUEST['atmid'];
    //echo $edit;
    $sql = "select * from gpssites where id='$edit'";
    ...
    $dvronline_details_sql = mysqli_query($conn, "select * from gpssites_details where dvrid='" . $edit . "' order by id desc");
...
?>
    ...
    <body style=" background-color:#dce079;">
        ...
        <div class="container" style="padding:20px;margin-top:90px">
            ...
            <form id="forms" action="updateOnlineGPS_process.php" method="POST" class="form1" enctype="multipart/form-data" onsubmit="return finalval()">
