...
{
    $abc="SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime,b.sendip FROM sites a,`alerts` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) and ((b.zone='003' and a.Panel_make='smart -i') or (b.zone='100' and a.Panel_make='sec') )  ";
   //echo $abc; 
}
...
<div align="center">total records:<?php echo $Num_Rows?></div>
  ...
  $incident_query= mysqli_query($conn,"select * from Testing_alertDetails where incident_id='".$row["id"]."' ");
...
if($row["sendip"]!=""){
 ...
 <tr style="background-color:#cfe8c7">
    <td><?php echo $sr;?></td>
	<!---<td><? echo "select * from loginaudit where UserLoginIP='".$row["sendip"]."'  and 	LogInDateTime like '%".$row["receivedtime"]."%' ";
?></td>-->
