...
include 'menu.php'; ?>
 ...
 <form id="forms" action="e_process_demo.php" method="POST" class="form1" enctype="multipart/form-data" onsubmit="return finalval()" autocomplete="off">
...
<div class="row div1">
   ...
   ?>
     ...
     <option value="<?php $fetchCTS['branch']; ?>"><?php echo $fetchCTS['branch']; ?></option>
   <?php } ?>
...
<div class="row div1">
    ...
    <div class="col-md-4"><leble>Router ID</leble></div>
     <div class="col-md-4"> <input type="text" name="router_id" id="router_id"></div>
      <div class="col-md-2"></div>
</div>
...
<div class="row div1">
    ...
    <div class="col-md-4"><leble>SIM Number</leble></div>
     <div class="col-md-4"> <input type="text" name="sim_number" id="sim_number"></div>
      <div class="col-md-2"></div>
</div>
...
for(let i= 0 ; i < 4 ; i++){
       ...
       html += "<div class='row div1'>  <div class='col-md-3'><lable>DVR IP</lable><input type='text' name='AddSite_DVRIP[]'></div> <div class='col-md-3'><lable>DVR Name</lable> <select name='AddSite_DVRName[]'><option value=''>Select Model</option> <?php $model_sql = mysqli_query($conn,'select * from dvr_name where bankwise_show=1'); while($model_sql_result = mysqli_fetch_array($model_sql)){ echo "<option>$model_sql_result[1]</option>"; } ?> </select> </div>        <div class='col-md-3'> <label>Username</label><input type='text' name='AddSite_UserName[]'> </div>   <div class='col-md-3'>  <label>Password</label><input type='text' name='AddSite_Password[]'></div></div>";
