...
<form id="forms" action="addcustomer_process.php" method="POST" class="form1" enctype="multipart/form-data" onsubmit="return finalval()">
    
<div class="row hed"  >
    <div  class="col-md-4"></div>
 <div  class="col-md-4"><center><h2  >Add Customer</h2></center></div>
 <div  class="col-md-4"></div>
</div>
...
<div class="row div1">
    ...
    <div  class="col-md-4"><leble>Customer Name</leble></div>
     <div  class="col-md-4"> <input type="text" name="cust" id="cust" style="width: 180px;"/>
     </div>
