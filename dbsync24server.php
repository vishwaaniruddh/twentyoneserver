...
echo mysqli_num_rows($result)."_";

$alldvrlive = mysqli_query($conn,"select * from all_dvr_live");
echo mysqli_num_rows($alldvrlive)."_"; 

$panel_health = mysqli_query($conn,"select * from panel_health");
echo mysqli_num_rows($panel_health)."_";


$dvr_site = mysqli_query($conn,"select * from dvrsite");
echo mysqli_num_rows($dvr_site)."_";

$dvr_online = mysqli_query($conn,"select * from dvronline");
echo mysqli_num_rows($dvr_online); die;
