...
include 'menu.php'; ?>
 ...
 site 
 <form id="forms" action="Project_AddSite_Process_old.php" method="POST" class="form1" enctype="multipart/form-data" onsubmit="return finalval()">
...
<?php 
$max="select max(SN) from sitesd where Project_Id='1'";
$runmax=mysqli_query($conn,$max);
$maxfetch=mysqli_fetch_array($runmax);

$max2="select NewPanelID  from sitesd where SN='".$maxfetch[0]."'";
...
<div class="row div1">
   <div  class="col-md-2"></div>
    <div  class="col-md-4"><leble>New Panel ID</leble></div>
     <div  class="col-md-4"> <input type="text" name="AddSite_NewPanelID" id="AddSite_NewPanelID" value="<?php echo "0".$np?>" /></div>
     <div  class="col-md-2"></div>
</div>
...
<div class="row div1 ">
     <div  class="col-md-2"></div>
    <div  class="col-md-4"><leble>Status</leble></div>
     <div  class="col-md-4">  <select name="Cloud_Status" id="Cloud_Status" style="width: 180px;"/>
...
<div class="row div1"  >
    ...
    <div  class="col-md-4"><lable>dvrname</lable></div>
     <div  class="col-md-4"><input type="text" name="Cloud_dvrname" id="Cloud_dvrname" ></div>
     <div  class="col-md-2"></div>
</div>
