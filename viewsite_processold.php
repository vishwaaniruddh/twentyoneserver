...
<center><div>Total Records:<?php echo $Num_Rows?></div></center>
  ...
  <tr>
   <th>Sr No</th>
	...
	<th>InternetPlans  </th>
	<th>BroadbandAmount  </th>
	
	<th>BroadbandAddress  </th>
	<th>MonthPlans   </th>
	<th>StartInternetDate </th>  
	<th>ExpiryDate</th>
...
$gsmfetch=mysqli_fetch_array($gsmrun);
 ...
 <?php echo $row["editby"];?></td>
   ...
   <td><?php echo $brodChkfetch["NetworkType"];?></td>
   <td><?php echo $brodChkfetch["ProviderName"];?></td>
   <td><?php echo $brodChkfetch["ProviderEmail"];?></td>
   <td><?php echo $brodChkfetch["ProviderMobile"];?></td>
   <td><?php echo $brodChkfetch["InternetPlans"];?></td>
   <td><?php echo $brodChkfetch["BroadbandAmount"];?></td>
   <td><?php echo $brodChkfetch["BroadbandAddress"];?></td>
   <td><?php echo $brodChkfetch["MonthPlans"];?></td>
   <td><?php echo $brodChkfetch["StartInternetDate"];?></td>
   <td><?php echo $brodChkfetch["ExpiryDate"];?></td>
   
   
   
   <td> <a href="edit2Demo.php?atmid=<?php echo $row[0]; ?>"  title="Edit" class="icon-1 info-tooltip">Edit</a></td>
...
$srno=1;
 ...
 <tr style="background-color:#cfe8c7">
	...
	<?php if($row['Status']!='Y'){?><td> <a href="sitelive.php?id=<?php echo $row[0]; ?>"  title="Live" class="icon-1 info-tooltip">Live</a></td><?php }else{ ?><td> </td><?php } ?>
