...
$result2=mysqli_query($conn,"select ATMID,Address,Location,State,IPAddress,`Rourt ID`,`Live Date`,UserName,Password,Status,dvrname,customer,SN from dvronline where modify=1");
...
while($row=mysqli_fetch_row($result2)){
	$qry2="insert into dvronline(ATMID,Address,Location,State,IPAddress,`Rourt ID`,`Live Date`,UserName,Password,Status,dvrname,customer,SN)values('$row[0]','$row[1]','$row[2]','$row[3]','$row[4]','$row[5]','$row[6]','$row[7]','$row[8]','$row[9]','$row[10]','$row[11]','$row[12]')";
...
$resultup2=mysqli_query($conn,"select ATMID,Address,Location,State,IPAddress,`Rourt ID`,`Live Date`,UserName,Password,Status,dvrname,customer,SN from dvronline where modify=2");
...
while($row=mysqli_fetch_row($resultup2)){
	$qry2="update dvronline set ATMID='$row[0]',Address='$row[1]',Location='$row[2]',State='$row[3]',IPAddress='$row[4]',`Rourt ID`='$row[5]',`Live Date`='$row[6]',UserName='$row[7]',Password='$row[8]',Status='$row[9]',dvrname='$row[10]',customer='$row[11]' where SN='$row[12]')";
	$res2=mysqli_query($cn,$qry2);
 if($res2)
	 mysqli_query($conn,"update dvronline set modify=0 where ATMID='$row[0]'");
}
