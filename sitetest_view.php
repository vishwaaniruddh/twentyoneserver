...
Page=strPage;
   ...
   $('#loadingmessage').show();  // show the loading message.
            ...
            type:'POST',    
   url:'sitetest_view_process.php',
   data:'DVRIP='+DVRIP+'&cssbm='+cssbm+'&Page='+Page+'&perpg='+perp+'&from='+from+'&to='+to,
...
<form id="formf" name="formf" method="post" action="css_View_Site_export.php" >
            ...
            <div>
			<center><h1 style="margin-top:70px; color:#fff;"  ><b> View visited Sites</b></h1></center>
...
<td >User Name:<select name="cssbm" id="cssbm" >
<option value="">Select NAME</option>
<?php 
include 'config.php';
$xyz="select id,name from loginusers where designation='3'";
$runxyz=mysqli_query($conn,$xyz);
while($xyzfetch=mysqli_fetch_array($runxyz)){

?>
<option value="<?php echo $xyzfetch['id'];?>"/><?php echo $xyzfetch['name']; ?></option>
<?php } ?>
</select></td>
