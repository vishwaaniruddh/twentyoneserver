...
<h2 style.top="30px">Upload Customer Data</h2>


<form action="customerDataMaintain_process.php" method="post" enctype="multipart/form-data" onSubmit="return validate(this)" name="form">

<table>
<tr>
    <td width="432" height="35"><b>Upload Excel:  <a href="Excel/updateData.xls" download>Download format </a></b></td>  
</tr>
<tr>
