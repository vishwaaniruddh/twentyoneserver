...
Page=strPage;
            ...
            type:'POST',    
   url:'sitelogDetails_process.php',
   data:'ATMID='+ATMID+'&from='+fromdt+'&to='+to+'&Page='+Page+'&perpg='+perp,
...
<form id="formf" name="formf" method="post" action="" >
            ...
            <div>
			<center><h1 style="margin-top:70px; color:#fff;"  ><b>View Site Log Report</b></h1></center>
