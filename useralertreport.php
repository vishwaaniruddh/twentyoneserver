...
Page=strPage;
   ...
   $('#loadingmessage').show();  // show the loading message.
            ...
            type:'POST',    
   url:'useralertreport_process.php',
   data:'user='+user+'&dt='+dt+'&dt2='+dt2+'&Page='+Page+'&perpg='+perp+'&shift='+shift,
   ...
   document.getElementById("show").innerHTML=msg;
      ...
      &nbsp;&nbsp;&nbsp;
        ...
        <body style="background-color: #dce079" align="center" ">
			...
			<center><h1 style="margin-top:70px; color:#fff;"  ><b>Alert Report</b></h1></center>
...
<td><select name="user" id="user" ><option value="all">All User</option>
           <?php
