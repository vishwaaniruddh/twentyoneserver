...
if($Bank=='PNB'){
		...
		for ($i=0; $i < count($DVRIP) ; $i++) { 
			$add_banksql = "insert into sites_info(site_id,atmid,cam_ip,cam_name,username,password,created_at,status) values('".$last2."','".$ATMID."','".$DVRIP[$i]."','".$DVRName[$i]."','".$UserName[$i]."','".$Password[$i]."','".$curentdt."','1')";
