...
if (isset($_SESSION['login_user']) && isset($_SESSION['id'])) {
    ...
    <div class="row div1">
        ...
        <div  class="col-md-4"><leble>ATMShort Name</leble></div>
         <div  class="col-md-4"> <input type="text" name="ATMShortName" id="ATMShortName" value="<?php echo $row['ATMShortName']; ?>" <?php if ($_edit == 0) {
               echo 'readonly';
           } ?> /></div>
         <div  class="col-md-2"></div>
    </div>
    ...
    <div class="row div1">
        ...
        <div  class="col-md-4"><leble>Site Address</leble></div>
         <div  class="col-md-4"> <input type="text" name="SiteAddress" id="SiteAddress" value="<?php echo $row['SiteAddress']; ?>" <?php if ($_edit == 0) {
               echo 'readonly';
           } ?> /></div>
        <div  class="col-md-2"></div>
    </div>
    ...
    <div class="row div1">
        ...
        <div  class="col-md-4">
            <select name="live" id="live"  <?php if ($_SESSION['id'] == "260" || $_SESSION['id'] == "24" || $_SESSION['id'] == "498" || $_SESSION['id'] == "496" || $_SESSION['id'] == "90" || $_SESSION['id'] == "28" || $_SESSION['id'] == "139" || $_SESSION['id'] == "74" || $_SESSION['id'] == "186" || $_SESSION['id'] == "46" || $_SESSION['id'] == "164" || $_SESSION['id'] == "206" || $_SESSION['id'] == "141" || $_SESSION['id'] == "296" || $_SESSION['id'] == "503" || $_SESSION['id'] == '268' || $_SESSION['id'] == '557') {
