...
<body>
  ...
  Select CUstomer
    ...
    From Date:<input type="date" id="fromdate" name="from" required>
 ...
 b.createtime as 'Incident Date Time',b.receivedtime as 'Alarm Received Date Time',
 b.receivedtime as 'Close Date Time',a.DVRIP
