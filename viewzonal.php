...
Page=strPage;
   ...
   document.getElementById("show").innerHTML=msg;
			...
			function deleteZonal(id){
				var conf=confirm("Are you sure to Delete Zonal?");
				if(conf==true){
				    $('#loadingmessage').show();  // show the loading message.
       				$.ajax({
					    type:'POST',    
					    url:'delete_zonal.php',
					    data:'id='+id,
					    success: function(msg){
						   $('#loadingmessage').hide(); // hide the loading message
					       if(msg==1){
							   alert('Zonal have been deleted successfully!');
							   window.location = "viewzonal.php";
						   }else{
							   alert('Zonal not deleted!');
						   }
					    } 
					})
				}else{
      ...
      &nbsp;&nbsp;&nbsp;
        <body onload="a('','')" style="background-color: #dce079">
            ...
            <div>
			<center><h1 style="margin-top:70px; color:#fff;"  ><b> View Zonal</b></h1></center>
