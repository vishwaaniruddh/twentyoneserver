...
if($row["alarm"]=="BA" and $row["zone"]=="551"){
?>
    <td><?php echo $date;?></td>
	<td><?php echo $time;?></td>
    <td><?php echo $date;?></td>
	...
	<?php 
	$xyz2="select createtime from alerts_acup where panelid='".$row['panelid']."' and zone='551' and alarm='BR' and createtime>'".$row['createtime']."' order by createtime limit 1";
	$xyzresult2=mysqli_query($conn,$xyz2);
	$xyzfetch2=mysqli_fetch_array($xyzresult2);
...
<?php 
	...
	$xyz1="select createtime from alerts_acup where panelid='".$row['panelid']."' and zone='552' and alarm='BR' and createtime>'".$row['createtime']."' order by createtime limit 1";
	$xyzresult1=mysqli_query($conn,$xyz1);
	$xyzfetch3=mysqli_fetch_array($xyzresult1);
	}else { $xyzfetch3[0]='-';?>
	<td>-</td>
