...
$sql="select * from site_circle_zonal  where 1=1  ";
...
<div align="center">total records:<?php echo $Num_Rows?></div>
 ...
 <tr style="background-color:#cfe8c7">
   ...
   <!-- <td> <a href="editcircle.php?userid=<?php echo $row[0]; ?>"  title="Edit" class="icon-1 info-tooltip">Edit</a></td>
    -->
   <!--<td><input type="button" onclick="window.open('delete_zonal.php?id=<?php echo $row[0];?>','_self');" value="Delete"></td>
    -->
	<td><input type="button" onclick="deleteZonal('<?php echo $row[0];?>');" value="Delete"></td>
  </tr>
