...
// $pdf->Cell(200,5,$pdf->writeHTML('<b>Mobile:</b> 7710835444 <b>Email-Id:</b> enquiry.allmart@gmail.com <b>Web:</b> www.allmart.world',1,'C'),1,'C');
$pdf->MultiCell(190,9,'Mobile: 7710835444 '.$pdf->SetFont('Arial','',12).'Email-Id: enquiry.allmart@gmail.com Web: www.allmart.world',1,'C');
...
$pdf->Cell(95,8,'TAX INVOICE No : '.$insert_id,1,0,'L',1);
$pdf->Cell(95,8,'Date :' . $newDate,1,0,'L',1);
...
$pdf->Cell(95,8,'Name : '.$name,1,0,'L',0);

$pdf->Cell(95,8,'Address: '.$address1,'LTR',0,'L',0);   // empty cell with left,top, and right borders
$pdf->Ln();



$pdf->Cell(95,8,'Mob No : '.$mobile,'1',0,'L',0);
...
$pdf->Cell(95,8,$address3,'LR',0,'L',0);   // empty cell with left,bottom, and right borders
$pdf->Ln();
...
$pdf->MultiCell(190,6,'Recieved with thanks Rs. 5,000/- Rupees - Five Thousand  Only/- . Only by RTGS / Payment Gateway on Date : '.$newDate,1);
