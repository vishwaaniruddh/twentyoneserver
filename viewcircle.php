...
Page=strPage;
   ...
   $('#loadingmessage').show();  // show the loading message.
            ...
            type:'POST',    
   url:'viewcircle_process.php',
   data:'name='+name+'&Page='+Page+'&perpg='+perp,
   ...
   document.getElementById("show").innerHTML=msg;
			...
			function deleteCircle(id){
				var conf=confirm("Are you sure to Delete Zonal?");
				if(conf==true){
				    $('#loadingmessage').show();  // show the loading message.
       				$.ajax({
					    type:'POST',    
					    url:'delete_circle.php',
					    data:'id='+id,
					    success: function(msg){
						   $('#loadingmessage').hide(); // hide the loading message
					       if(msg==1){
							   alert('Circle have been deleted successfully!');
							   window.location = "viewcircle.php";
						   }else{
      ...
      &nbsp;&nbsp;&nbsp;
        <body onload="a('','')" style="background-color: #dce079">
            ...
            <div>
			<center><h1 style="margin-top:70px; color:#fff;"  ><b> View Circle</b></h1></center>
...
<td> Circle Name:<input type="text" name="name" id="name" ></td>
