...
<div class="container" style="padding:20px;margin-top:90px">
  <form id="forms" action="updateTesting.php" method="POST" class="form1" enctype="multipart/form-data" onsubmit="return finalval()">
<div class="row hed"  >
...
<div class="row div1">
    ...
    <div  class="col-md-4">
        <select name="live" id="live"  <?php if($_SESSION['id']=="24" || $_SESSION['id']=="498" || $_SESSION['id']=="496" || $_SESSION['id']=="90"  || $_SESSION['id']=="28" || $_SESSION['id']=="139" || $_SESSION['id']=="74" || $_SESSION['id']=="186" || $_SESSION['id']=="46" || $_SESSION['id']=="164" || $_SESSION['id']=="206" || $_SESSION['id']=="141" || $_SESSION['id']=="296" || $_SESSION['id']=="503" || $_SESSION['id']=='268' || $_SESSION['id']=='557' ){ echo " style='width: 180px;display:block' ";  }else{ echo " style='width: 180px;display:none' ";   }?> />
